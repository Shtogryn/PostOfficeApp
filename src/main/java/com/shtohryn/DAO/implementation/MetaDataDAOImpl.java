    ...
    public List<TableMetaData> getTablesStructure() throws SQLException {
        ...
        while (result.next()) {
            ...
            while (columnsRS.next()) {
                ...
                columnMetaData.setColName(columnsRS.getString("COLUMN_NAME"));
                columnMetaData.setDataType(columnsRS.getString("TYPE_NAME"));
                columnMetaData.setColSize(columnsRS.getString("COLUMN_SIZE"));
            ...
            while (FKsRS.next()) {
                ...
                fk.setFkColName(FKsRS.getString("FKCOLUMN_NAME"));
                fk.setPkTableName(FKsRS.getString("PKTABLE_NAME"));
                fk.setPkColName(FKsRS.getString("PKCOLUMN_NAME"));
